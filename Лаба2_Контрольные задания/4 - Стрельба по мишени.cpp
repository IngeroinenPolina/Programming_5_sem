// Контрольное задание 4.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main()
{
    ...
    if (sum < 25)
    {
        cout << "Вы совершили  " << col << " выстрелов. Ваш уровень - нович0к";
    }
    if ((sum >= 25) && (sum < 50))
    {
